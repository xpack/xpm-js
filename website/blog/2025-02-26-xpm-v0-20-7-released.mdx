...
title: xPack xpm v0.20.7 released
seo_title: Version 0.20.7 released
description: Version v0.20.7 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
release_tag_url: "https://github.com/xpack/xpm-js/tree/v0.20.7"
...
Version **0.20.7** is a maintenance release; it fixes extended dependencies syntax processing.
...
npm xpm@0.20.7 '/Users/ilg/.nvm/versions/node/v18.20.4/lib/node_modules/xpm'
