...
seo_title: Version 0.16.2 released
description: Version 0.16.2 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.16.2** is a maintenance release, it fixes a bug in processing url dependencies.
