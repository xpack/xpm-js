...
seo_title: Version 0.19.1 released
description: Version 0.19.1 is a new release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.19.1** is a new release, it fixes the dependencies bug and upgrades to node 18.
