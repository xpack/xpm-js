...
title: xPack xpm v0.22.7 released
seo_title: Version 0.22.7 released
description: Version v0.22.7 is a new release.
keywords:
  - xpack
  - xpm
  - release

date: 2026-02-18 23:11:05 +0200
...
release_tag_url: "https://github.com/xpack/xpm-js/tree/v0.22.7"
...
Version **0.22.7** is a new release; it adds support for templated matrix strategies in actions and build configurations.
...
- [[#230](https://github.com/xpack/xpm-js/issues/230)]: add a dependency to 
`xpm-lib` (instead of `xpm-liquid`) as it now implements template substitutions.
...
npm xpm@0.22.7 '/Users/ilg/.nvm/versions/node/v18.20.4/lib/node_modules/xpm'
