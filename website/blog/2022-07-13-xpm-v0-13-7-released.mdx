...
seo_title: Version 0.13.7 released
description: Version 0.13.7 is a new release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.13.7** is a new release; it purges the node_modules folder of unnecessary packages.
