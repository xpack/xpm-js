...
seo_title: Version 0.16.4 released
description: Version 0.16.4 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.16.4** is a maintenance release, it fixes some bugs affecting list, uninstall and install with --copy.
