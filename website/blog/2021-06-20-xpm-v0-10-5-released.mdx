...
seo_title: Version 0.10.5 released
description: Version 0.10.5 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.10.5** is a maintenance release; it adds warnings for extra xpm init args.
