...
seo_title: Version 0.14.3 released
description: Version 0.14.3 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.14.3** is a maintenance release; it adds some more trace messages to help diagnose a bug.
