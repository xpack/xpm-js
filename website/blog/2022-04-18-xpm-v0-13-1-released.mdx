...
seo_title: Version 0.13.1 released
description: Version 0.13.1 is a new release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.13.1** is a new release; it fixes several issues and adds support for inheritance in build configurations.
