...
seo_title: Version 0.14.9 released
description: Version 0.14.9 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.14.9** is a maintenance release; it fixes the download issues.
