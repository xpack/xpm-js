...
title: xPack xpm v0.20.8 released
seo_title: Version 0.20.8 released
description: Version v0.20.8 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release

date: 2025-03-03 23:57:03 +0200
...
release_tag_url: "https://github.com/xpack/xpm-js/tree/v0.20.8"
...
Version **0.20.8** is a maintenance release; it fixes the `xpm init` bug.
...
- [[#221](https://github.com/xpack/xpm-js/issues/221)]: Due to a bug in a
configuration file, the previous release missed one file required by
`xpm init`; fixed
...
npm xpm@0.20.8 '/Users/ilg/.nvm/versions/node/v18.20.4/lib/node_modules/xpm'
