...
seo_title: Version 0.10.2 released
description: Version 0.10.2 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.10.2** is a maintenance release; it bundles dependencies to avoid install warnings.
