...
description: Version 0.19.3 is a maintenance release of xPack Project Manager.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.19.3** is a maintenance release, it fixes shims on Windows (the ld.gold issue).
