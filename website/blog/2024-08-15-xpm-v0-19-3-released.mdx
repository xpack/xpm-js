...
seo_title: Version 0.19.3 released
description: Version 0.19.3 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.19.3** is a maintenance release, it fixes the bug that incorrectly added npm dependencies.
...
- [#206] in certain conditions, executables with extensions failed to get Windows shims; fixed.
