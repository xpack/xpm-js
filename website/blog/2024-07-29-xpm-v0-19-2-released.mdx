...
seo_title: Version 0.19.2 released
description: Version 0.19.2 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.19.2** is a maintenance release, it fixes the bug that incorrectly added npm dependencies.
