...
seo_title: Version 0.14.2 released
description: Version 0.14.2 is a new major release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.14.2** is a new major release; it separates xPack from npm dependencies.
