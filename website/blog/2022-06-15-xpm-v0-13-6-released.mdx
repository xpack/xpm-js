...
seo_title: Version 0.13.6 released
description: Version 0.13.6 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.13.6** is a maintenance release; it fixes passing args to single command actions.
