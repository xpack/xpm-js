...
seo_title: Version 0.19.4 released
description: Version 0.19.4 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release

date: 2024-10-19 16:07:00 +0300
...
Version **0.19.4** is a maintenance release, it fixes the bug that incorrectly added npm dependencies.
...
- [#207] in certain conditions, downloads behind a proxy failed; fixed.
