...
description: Version 0.19.4 is a maintenance release of xPack Project Manager.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.19.4** is a maintenance release, it fixes the HttpsProxyAgent import.
