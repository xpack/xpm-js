...
title: xPack xpm v0.23.3 released
seo_title: Version 0.23.3 released
description: Version v0.23.3 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release

date: 2026-09-20 17:34:42 +0300
...
release_tag_url: "https://github.com/xpack/xpm-js/tree/v0.23.3"
...
Version **0.23.3** is a maintenance release; it fixes the `isNpmPackage` bug.
...
- [[#232](https://github.com/xpack/xpm-js/issues/232)]: in certain conditions, 
`xpm link` fails to correctly identify npm packages; fixed.
...
npm xpm@0.23.3 '/Users/ilg/.nvm/versions/node/v18.20.4/lib/node_modules/xpm'
