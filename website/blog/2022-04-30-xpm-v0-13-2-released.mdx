...
seo_title: Version 0.13.2 released
description: Version 0.13.2 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.13.2** is a maintenance release; it fixes a small displaying bug.
