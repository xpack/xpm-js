...
title: xPack xpm v0.23.2 released
seo_title: Version 0.23.2 released
description: Version v0.23.2 is a maintenance release, to fix the inNpmPackage bug.
keywords:
  - xpack
  - xpm
  - release

date: 2026-03-09 23:42:25 +0200
...
release_tag_url: "https://github.com/xpack/xpm-js/tree/v0.23.2"
...
Version **0.23.2** is a maintenance release; it fixes the `inNpmPackage` bug.
...
- [[#231](https://github.com/xpack/xpm-js/issues/231)]: the previous major 
  re-work introduced a bug, a wrong function name; fixed.
...
npm xpm@0.23.2 '/Users/ilg/.nvm/versions/node/v18.20.4/lib/node_modules/xpm'
