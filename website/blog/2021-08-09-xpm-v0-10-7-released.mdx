...
seo_title: Version 0.10.7 released
description: Version 0.10.7 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.10.7** is a maintenance release; it fixes the missing --global in the Windows update check.
