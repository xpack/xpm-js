...
seo_title: Version 0.15.1 released
description: Version 0.15.1 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.15.1** is a maintenance release, it fixes some Windows specific bugs.
