...
seo_title: Version 0.13.5 released
description: Version 0.13.5 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.13.5** is a maintenance release; it filters out hidden configurations in `install --all-configs`.
