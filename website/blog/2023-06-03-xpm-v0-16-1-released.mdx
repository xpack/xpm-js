...
seo_title: Version 0.16.1 released
description: Version 0.16.1 is a new release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.16.1** is a new release, it adds support for `--copy` and hierarchical xpacks folder.
