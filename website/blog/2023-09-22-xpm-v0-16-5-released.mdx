...
seo_title: Version 0.16.5 released
description: Version 0.16.5 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.16.5** is a maintenance release, it fixes the bug affecting xpm init without git configuration.
