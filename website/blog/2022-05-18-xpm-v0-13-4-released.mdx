...
seo_title: Version 0.13.4 released
description: Version 0.13.4 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.13.4** is a maintenance release; it fixes a small bug conducting to an irrelevant warning.
