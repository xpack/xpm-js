...
title: xPack xpm v0.21.4 released
seo_title: Version 0.21.4 released
description: Version v0.21.4 is a new release.
keywords:
  - xpack
  - xpm
  - release

date: 2025-11-27 23:19:11 +0200
...
release_tag_url: "https://github.com/xpack/xpm-js/tree/v0.21.4"
...
Version **0.21.4** is a new release; it improves LiquidJS processing, allowing dynamic actions creation.
...
- The LiquidJS engine has been improved to allow dynamic creation of commands
  via substitutions; this allows more flexible `xpm run` scripts.
...
npm xpm@0.21.4 '/Users/ilg/.nvm/versions/node/v18.20.4/lib/node_modules/xpm'
