...
title: xPack xpm v0.21.3 released
seo_title: Version 0.21.3 released
description: Version v0.21.3 is a new release.
keywords:
  - xpack
  - xpm
  - release

date: 2025-11-27 21:27:11 +0200
...
release_tag_url: "https://github.com/xpack/xpm-js/tree/v0.21.3"
...
Version **0.21.3** is a new release; it improves LiquidJS processing, allowing dynamic actions creation.
...
npm xpm@0.21.3 '/Users/ilg/.nvm/versions/node/v18.20.4/lib/node_modules/xpm'
