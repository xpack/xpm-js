...
title: xPack xpm v0.20.5 released
seo_title: Version 0.20.5 released
description: Version v0.20.5 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release

date: 2024-12-11 00:05:08 +0200
...
release_tag_url: "https://github.com/xpack/xpm-js/tree/v0.20.5"
...
Version **0.20.5** is a maintenance release; it fixes two bugs related to `uninstall` and `link`.
...
- [#217] `xpm uninstall` for a binary package in a build configurations did not remove the links to executables; fixed
- [#218] `xpm link` with a scoped package did not create intermediate folders; fixed.
...
npm xpm@0.20.5 '/Users/ilg/.nvm/versions/node/v18.20.4/lib/node_modules/xpm'
