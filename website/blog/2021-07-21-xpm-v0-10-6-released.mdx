...
seo_title: Version 0.10.6 released
description: Version 0.10.6 is a maintenance release.
keywords:
  - xpack
  - xpm
  - release
...
Version **0.10.6** is a maintenance release; it better processes errors while checking for updates.
