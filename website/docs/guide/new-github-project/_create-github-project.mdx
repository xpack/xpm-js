...
- click the green **New** button to create a new repository
  ...
  an xpm package, it is recommended to suffix the project name with `-xpack`.

  :::
  - enter **Description** (like _A source library package with ..._ or _A binary package with ..._; without a trailing full stop)
  - select **Public**
...
- in a terminal window, in a place of our choice, create a folder
  to store all xpm packages (for example it can be named `xPacks`):
...
### Create the `xpack` branch (important)
