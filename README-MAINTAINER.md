...
add a new milestone like `0.10.7` (without `v`)
...
- commit with a message like _prepare v0.10.7_
...
- name the post like: **xPack xpm v0.10.7 released**
...
- `npm dist-tag ls xpm`
- `npm dist-tag add xpm@0.10.7 latest`
- `npm dist-tag ls xpm`
...
- paste the release name like **xPack xpm v0.10.7 released**
