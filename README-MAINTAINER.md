...
add a new milestone like `0.12.1` (without `v`)
...
- commit with a message like _prepare v0.12.1_
...
- name the post like: **xPack xpm v0.12.1 released**
...
- commit with a message like **xPack xpm v0.12.1 release**
- push
...
- `npm dist-tag ls xpm`
- `npm dist-tag add xpm@0.12.1 latest`
- `npm dist-tag ls xpm`
...
- paste the release name like **xPack xpm v0.12.1 released**
