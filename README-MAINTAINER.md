...
Edit `package.json` to this version suffixed by `-pre` (like `0.14.3-pre`).
...
add a new milestone like `0.14.3` (without `v`)
...
- commit with a message like _prepare v0.14.3_
...
- name the post like: **xPack xpm v0.14.3 released**
...
- commit with a message like **xPack xpm v0.14.3 release**
- push
...
- `npm dist-tag ls xpm`
- `npm dist-tag add xpm@0.14.3 latest`
- `npm dist-tag ls xpm`
...
- paste the release name like **xPack xpm v0.14.3 released**
