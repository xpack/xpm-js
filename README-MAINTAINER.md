...
Edit `package.json` to this version suffixed by `-pre` (like `0.14.6-pre`).
...
add a new milestone like `0.14.6` (without `v`)
...
- add an entry with the new version _* v0.14.6 released_
- commit with a message like _prepare v0.14.6_
...
- name the post like: **xPack xpm v0.14.6 released**
...
- commit with a message like **xPack xpm v0.14.6 release**
- push
...
- `npm dist-tag ls xpm`
- `npm dist-tag add xpm@0.14.6 latest`
- `npm dist-tag ls xpm`
...
- paste the release name like **xPack xpm v0.14.6 released**
