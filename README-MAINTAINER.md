...
add a new milestone like `0.11.0` (without `v`)
...
- commit with a message like _prepare v0.11.0_
...
- name the post like: **xPack xpm v0.11.0 released**
...
- commit with a message like **xPack xpm v0.11.0 release**
- push
...
- `npm dist-tag ls xpm`
- `npm dist-tag add xpm@0.11.0 latest`
- `npm dist-tag ls xpm`
...
- paste the release name like **xPack xpm v0.11.0 released**
