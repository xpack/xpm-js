...
add a new milestone like `0.12.4` (without `v`)
...
- commit with a message like _prepare v0.12.4_
...
- name the post like: **xPack xpm v0.12.4 released**
...
- commit with a message like **xPack xpm v0.12.4 release**
- push
...
- `npm dist-tag ls xpm`
- `npm dist-tag add xpm@0.12.4 latest`
- `npm dist-tag ls xpm`
...
- paste the release name like **xPack xpm v0.12.4 released**
