...
Edit `package.json` to this version suffixed by `-pre` (like `0.19.2-pre`).
...
add a new milestone like `0.19.2` (without `v`)
...
- add an entry with the new version _* v0.19.2 released_
- commit with a message like _prepare v0.19.2_
...
- name the post like: **xPack xpm v0.19.2 released**
...
- commit with a message like **xPack xpm v0.19.2 release**
- push
...
- `npm dist-tag ls xpm`
- `npm dist-tag add xpm@0.19.2 latest`
- `npm dist-tag ls xpm`
...
In the issues milestones, close 0.19.2:
...
- paste the release name like **xPack xpm v0.19.2 released**
